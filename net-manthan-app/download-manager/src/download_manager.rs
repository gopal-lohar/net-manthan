...
impl DownloadManager {
    ...
    pub fn start_download(&mut self, download_id: u64, request: DownloadRequest) -> broadcast::Receiver<DownloadProgress> {
        ...
        tokio::spawn(download(download_id, request, handle.cancel_token.clone(), broadcast_sender));
