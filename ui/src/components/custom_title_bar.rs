    ...
    pub fn view(&self, ui_config: &UiConfig) -> Element<'_, TitleBarMessage> {
        if ui_config.custom_decoration {
                    ...
                    .style(|theme, status| {
                        ...
                        match status {
                            button::Status::Hovered => button::Style {
                                background: Some(
                                    palette.background.weak.color.scale_alpha(0.1).into(),
                                ),
                                ..base
                            },
                            _ => base,
            ...
            let title_bar = container(
                row![
                    text(&self.title),
                    mouse_area(container("").width(Length::Fill))
                    ...
                    row![
                        ...
                        title_bar_button(
                            ...
                            TitleBarMessage::ToggleMaximize(ui_config.maximized)
                        ),
